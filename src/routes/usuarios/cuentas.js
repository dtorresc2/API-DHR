...
router.put('/cuentas/:id/pass', guardia, async (req, res) => {
   const { PASSWORD } = req.body;
   req.body.PASSWORD = bcrypt.hashSync(PASSWORD, 10);
...
router.delete('/cuentas/:id', guardia, async (req, res) => {
